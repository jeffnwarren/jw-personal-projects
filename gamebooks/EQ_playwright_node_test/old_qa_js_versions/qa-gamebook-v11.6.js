...
//
// USAGE:
//   node qa-gamebook-v11.6.js [flags] "Dungeon_of_Dread.html"
//
// Example:
//   node qa-gamebook-v11.6.js --headed --progress --slowMo=50 "Dungeon_of_Dread.html"
//
// NOTES:
...
// -----------------------------------------
// CLI options
//   node qa-gamebook-v11.6.js [--headed] [--progress] [--progressEvery=25] [--maxStates=5000] [--slowMo=0] [--timeoutMs=1500] "path/to/book.html"
...
(async () => {
  ...
  if (!filePath) {
    console.error('Usage: node qa-gamebook-v11.6.js [--headed] [--progress] [--progressEvery=25] [--maxStates=5000] [--slowMo=0] [--timeoutMs=1500] [--outputLog[=<name>]] "C:\\path\\to\\Dungeon_of_Dread.html"');
    process.exit(1);
  }
